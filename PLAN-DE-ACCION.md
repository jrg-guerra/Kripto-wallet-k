...
| v4e | 2026-09-01 | el sello y su test cubren TAMBIÉN `aprendizaje.mjs` | v4d selló la cadena del motor y dejó el otro módulo igual de ciego: los umbrales de `regimenMercado` —que ese día vetaron los 12 candidatos— cambiaban sin mover el sello | cerrado 2026-09-15 | `m-c9006559` |
| v4f | 2026-09-15 | RLUSD entra a las stables y nace un detector de conducta: bajo 0,5% de volatilidad diaria un activo no es operable | RLUSD no estaba declarada, el motor la ofreció como candidata y la frenó la compuerta por R:B — el control correcto por la razón equivocada; nombrarlas una por una persigue el síntoma | **vigente** | `m-6757e03c` |
