...
| v4d | 2026-09-01 | el sello cubre la CADENA CAUSAL completa (34 funciones, no 5) y un test exige que toda función del motor esté clasificada | la huella es del cuerpo de una función, no de las que llama: cambiar `BANDA_RUIDO_VOL` dentro de `umbralPlazoPct` no movía el hash aunque `evaluarNiveles` estuviera sellada | **vigente** | `m-3944ea1d` |
