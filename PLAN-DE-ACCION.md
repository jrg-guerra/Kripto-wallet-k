...
| v4a | *candidata* | dejar correr al ganador: objetivo más ancho o trailing amplio | 5 de 6 salidas siguieron subiendo; costó 2,28 USDT netos a 48 h, casi el alfa entero del proyecto. Backtest 429 ventanas: objetivo +25% da +1,124% medio vs +0,440% del +15%; trailing 10% desde +10% da +1,157%. **El trailing ajustado (6% desde +8%) es PEOR: +0,289%** | **pendiente: decidir al cierre del ciclo (25-ago) con backtest propio; n=6 en cierres reales está bajo el umbral** | — |
| v3f | 2026-08-23 | compuerta en la jugada manual + el monitor escribe la serie | `/api/jugada` se saltaba los cinco controles; el freno de caída medía contra un pico observado | **vigente** | `m-6abe7991` |
